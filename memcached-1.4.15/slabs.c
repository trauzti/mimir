...
slabclass_t *get_slab_class(int id)
{
  return &slabclass[id];
}
...
// put every item from this page into the freelist for the slabclass
...
// this takes one item and puts it into the freelist for the slabclass
static void do_slabs_free(void *ptr, const size_t size, unsigned int id) {
    slabclass_t *p;
    item *it;
